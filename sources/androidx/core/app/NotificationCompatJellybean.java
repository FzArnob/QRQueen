...
class NotificationCompatJellybean {
    ...
    private static RemoteInput fromBundle(Bundle bundle) {
        ...
        return new RemoteInput(bundle.getString(KEY_RESULT_KEY), bundle.getCharSequence(KEY_LABEL), bundle.getCharSequenceArray("choices"), bundle.getBoolean(KEY_ALLOW_FREE_FORM_INPUT), bundle.getBundle(KEY_EXTRAS), hashSet);
    }
