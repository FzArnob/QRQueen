    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(i2) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                childAt.measure(getChildMeasureSpec(i, getPaddingLeft() + getPaddingRight() + layoutParams.leftMargin + layoutParams.rightMargin, layoutParams.width), View.MeasureSpec.makeMeasureSpec(measuredHeight2, Declaration.MODULE_REFERENCE));
            }
        }
    }
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (dispatchNestedScroll(0, scrollY2, 0, i4 - scrollY2, this.mScrollOffset, 0)) {
                            ...
                            obtain.offsetLocation(0.0f, (float) i7);
                            this.mNestedYOffset += this.mScrollOffset[1];
                        } else if (z) {
                            ensureGlows();
                            int i8 = scrollY + i4;
                            if (i8 < 0) {
                                ...
                                int i9 = i5;
                                if (i8 > i3) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowBottom, ((float) i4) / ((float) getHeight()), 1.0f - (motionEvent2.getX(i9) / ((float) getWidth())));
