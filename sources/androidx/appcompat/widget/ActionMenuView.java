...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
        ...
        if (z2) {
            for (int i34 = 0; i34 < childCount; i34++) {
                ...
                if (layoutParams5.expanded) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i11) + layoutParams5.extraPixels, Declaration.MODULE_REFERENCE), childMeasureSpec);
                }
            }
        }
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(View.MeasureSpec.makeMeasureSpec(i * i5, Declaration.MODULE_REFERENCE), makeMeasureSpec);
        return i5;
    }
