        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    i11 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i15, Declaration.MODULE_REFERENCE);
                } else {
                    i11 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, Declaration.MODULE_REFERENCE);
                }
                if (layoutParams.height == -2) {
                    i12 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    i12 = View.MeasureSpec.makeMeasureSpec(i3, Declaration.MODULE_REFERENCE);
                } else {
                    i12 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, Declaration.MODULE_REFERENCE);
                }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), Declaration.MODULE_REFERENCE);
                                } else if (layoutParams2.height == -2) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                } else if (layoutParams2.height == -1) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(i3, Declaration.MODULE_REFERENCE);
                                } else {
                                    i8 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, Declaration.MODULE_REFERENCE);
                                }
                                if (z2) {
                                    int i18 = paddingLeft - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                    i6 = i16;
                                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i18, Declaration.MODULE_REFERENCE);
                                    if (i7 != i18) {
                                    ...
                                    i6 = i16;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(i7 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i13))) / f)), Declaration.MODULE_REFERENCE), i8);
                                    i17++;
                                    i16 = i6;
                                    i5 = 8;
                                }
                            ...
                            if (!z4) {
                                ...
                                i10 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), Declaration.MODULE_REFERENCE);
                            } else if (layoutParams2.height == -2) {
                                i10 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                i9 = Declaration.MODULE_REFERENCE;
                            } else if (layoutParams2.height == -1) {
                                i9 = Declaration.MODULE_REFERENCE;
                                i10 = View.MeasureSpec.makeMeasureSpec(i3, Declaration.MODULE_REFERENCE);
                            } else {
                                i9 = Declaration.MODULE_REFERENCE;
                                i10 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, Declaration.MODULE_REFERENCE);
                            }
