...
public class ExifOrientationStream extends FilterInputStream {
    ...
    static {
        byte[] bArr = {-1, -31, 0, 28, Ev3Constants.Opcode.CP_LT16, Ev3Constants.Opcode.JR_GTEQ8, Ev3Constants.Opcode.JR_GT16, Ev3Constants.Opcode.JR_LT32, 0, 0, Ev3Constants.Opcode.CP_EQ16, Ev3Constants.Opcode.CP_EQ16, 0, 0, 0, 0, 0, 8, 0, 1, 1, 18, 0, 2, 0, 0, 0, 1, 0};
        EXIF_SEGMENT = bArr;
    ...
    public int read() throws IOException {
        ...
        if (i3 < 2 || i3 > (i2 = ORIENTATION_POSITION)) {
            ...
            i = EXIF_SEGMENT[i3 - 2] & Ev3Constants.Opcode.TST;
        }
        if (i != -1) {
            this.position++;
        }
