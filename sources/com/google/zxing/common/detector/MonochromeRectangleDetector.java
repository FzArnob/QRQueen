    ...
    private ResultPoint findCornerFromCenter(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) throws NotFoundException {
        ...
        while (i14 < i12 && i14 >= i7 && i13 < i4 && i13 >= i3) {
            ...
            if (iArr != null) {
                ...
                return new ResultPoint(i6 > 0 ? (float) i16 : (float) i17, (float) i15);
            } else {
                int i18 = i13 - i2;
                int i19 = iArr2[0];
                if (i19 >= i11) {
                    return new ResultPoint((float) i18, (float) iArr2[1]);
                }
                int i20 = iArr2[1];
                if (i20 <= i11) {
                    return new ResultPoint((float) i18, (float) i19);
                }
                return new ResultPoint((float) i18, i2 < 0 ? (float) i19 : (float) i20);
            }
        }
        throw NotFoundException.getNotFoundInstance();
    }
